    ...
    , ui(new Ui::MainWindow)
{
    ...
    QFile file("C:/Users/123/Desktop/MusicList.txt");
    ...
    connect(ui->pushButton_15,&QPushButton::clicked,[=]()mutable{
        ...
        if(playsetstats%2==1)
        {
            ...
            this->Playstate=1;
            QString path;
            path="C:/Users/123/Desktop/FindMusic/"+Musicname.at(musicnum);
    ...
    connect(ui->pushButton_16,&QPushButton::clicked,[=]()mutable{
        ...
        if(this->player==nullptr)
        {
            ...
            file.close();
            QString path;
            path="C:/Users/123/Desktop/FindMusic/"+Musicname.at(this->musicnum);
