...
void Mythread::run()
{
    QFile file1("C:/Users/123/Desktop/MusicList.txt");
    ...
    qDebug()<<"导入";
    QString path;
    path="C:/Users/123/Desktop/FindMusic/"+this->Musicname;
    QString Musicpath=QDir::toNativeSeparators(path)+".mp3";
    qDebug()<<Musicpath;
    ...
    player->play();
    QString imgpath;
//    imgpath="C:/Users/123/Desktop/MusicPage/"+this->Musicname+".jpg";
    imgpath="C:/Users/123/Desktop/MusicPage/test.jpg";
    ...
    QImage back(imgpath);
    back_colorint=back.pixel(90,90);
    qDebug()<<back_colorint;
    back_color=QColor(back_colorint);
    back_palette=this->playpage->palette();
    back_palette.setColor(QPalette::Window,QColor(back_color));
    this->playpage->setPalette(back_palette);
    connect(this->playpage->Addlistbtn,&QPushButton::clicked,[=](){
        qDebug()<<"this music add to list";
        QFile file("C:/Users/123/Desktop/MusicList.txt");//打开存放有搜索内容文本文件
